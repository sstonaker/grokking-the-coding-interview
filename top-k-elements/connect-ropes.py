...
def main():
    ...
    print(
        f"Minimum cost to connect ropes: {str(minimum_cost_to_connect_ropes([1, 3, 11, 5]))}")
    print(
        f"Minimum cost to connect ropes: {str(minimum_cost_to_connect_ropes([3, 4, 5, 6]))}")
    print(
        f"Minimum cost to connect ropes: {str(minimum_cost_to_connect_ropes([1, 3, 11, 5, 2]))}")

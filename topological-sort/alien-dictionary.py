...
Output: bac
Explanation: Given that the words are sorted lexicographically by the rules of
the alien language, so
...
From the above two points, we can conclude that the correct character order is:
"bac"
Example 2:
...
def main():
    ...
    print(
        f'Character order: {find_order(["ywx", "wz", "xww", "xz", "zyy", "zwz"])}')

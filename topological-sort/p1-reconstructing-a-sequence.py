...
def main():
    print(
        f"Can construct: {str(can_construct([1, 2, 3, 4], [[1, 2], [2, 3], [3, 4]]))}")
    print(
        f"Can construct: {str(can_construct([1, 2, 3, 4], [[1, 2], [2, 3], [2, 4]]))}")
    print(
        f"Can construct: {str(can_construct([3, 1, 4, 2, 5], [[3, 1, 5], [1, 4, 2, 5]]))}")

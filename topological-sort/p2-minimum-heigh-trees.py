...
Output:[0, 2]
Explanation: Choosing '0' or '2' as roots give us MHTs. In the below diagram,
we can see that the
...
def main():
    print(
        f"Roots of MHTs: {str(find_trees(5, [[0, 1], [1, 2], [1, 3], [2, 4]]))}")
    print(f"Roots of MHTs: {str(find_trees(4, [[0, 1], [0, 2], [2, 3]]))}")
    print(f"Roots of MHTs: {str(find_trees(4, [[1, 2], [1, 3]]))}")
